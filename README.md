...
The YAML / Python domain stays `nabla_display` for compatibility; the product name is **Nabla Control**. In passing, it is also a **Home Assistant Control System** for these devices.
